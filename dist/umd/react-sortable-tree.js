        ...
        var _treeNode = __webpack_require__(11), _treeNode2 = _interopRequireDefault(_treeNode), _nodeRendererDefault = __webpack_require__(9), _nodeRendererDefault2 = _interopRequireDefault(_nodeRendererDefault), _treeDataUtils = __webpack_require__(1), _memoizedTreeDataUtils = __webpack_require__(8), _genericUtils = __webpack_require__(13), _defaultHandlers = __webpack_require__(6), _dragAndDropUtils = __webpack_require__(7), _reactSortableTree = __webpack_require__(20), _reactSortableTree2 = _interopRequireDefault(_reactSortableTree), dndTypeCounter = 1, ReactSortableTree = function(_Component) {
            ...
            return _inherits(ReactSortableTree, _Component), _createClass(ReactSortableTree, [ {
                ...
                value: function(input) {
                    var node = input.node, depth = input.depth, minimumTreeIndex = input.minimumTreeIndex, prevPath = input.path, _insertNode = (0, 
                ...
                value: function(_ref3) {
                    var path = _ref3.path, draggingTreeData = (0, _treeDataUtils.removeNodeAtPath)({
                        treeData: this.props.treeData,
                        path: path,
                        getNodeKey: this.props.getNodeKey
                    });
                ...
                value: function(_ref4) {
                    var draggedNode = _ref4.node, depth = _ref4.depth, minimumTreeIndex = _ref4.minimumTreeIndex, draggingTreeData = this.state.draggingTreeData || this.props.treeData, addedResult = (0, 
                ...
                value: function() {
                    ...
                    (0, _treeDataUtils.walk)({
                        ...
                        callback: function(_ref6) {
                            var node = _ref6.node, path = _ref6.path, lowerSiblingCounts = _ref6.lowerSiblingCounts, treeIndex = _ref6.treeIndex;
                ...
                key: "renderRow",
                value: function(_ref8, listIndex, style, getPrevRow, matchKeys) {
                    var node = _ref8.node, parentNode = _ref8.parentNode, path = _ref8.path, lowerSiblingCounts = _ref8.lowerSiblingCounts, treeIndex = _ref8.treeIndex, _props = this.props, canDrag = _props.canDrag, canDrop = _props.canDrop, generateNodeProps = _props.generateNodeProps, getNodeKey = _props.getNodeKey, maxDepth = _props.maxDepth, scaffoldBlockPxWidth = _props.scaffoldBlockPxWidth, searchFocusOffset = _props.searchFocusOffset, TreeNodeRenderer = this.treeNodeRenderer, NodeContentRenderer = this.nodeContentRenderer, nodeKey = path[path.length - 1], isSearchMatch = nodeKey in matchKeys, isSearchFocus = isSearchMatch && matchKeys[nodeKey] === searchFocusOffset, callbackParams = {
                        node: node,
                        parentNode: parentNode,
                        path: path,
                        lowerSiblingCounts: lowerSiblingCounts,
